...
- [`lib/supabase.js`](C:/Users/cindi/OneDrive/Documents/GitHub/pttracker/lib/supabase.js): Shared Supabase client for the Next.js app. Import `supabase` from here; do not create a new client elsewhere in Next.js pages/hooks. Auth persistence uses the shared IndexedDB-backed storage adapter from `lib/offline-cache.js`.
