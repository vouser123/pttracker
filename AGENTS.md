...
- Follow [`docs/TYPESCRIPT_POLICY.md`](C:/Users/cindi/OneDrive/Documents/GitHub/pttracker/docs/TYPESCRIPT_POLICY.md) for the canonical language policy. Default new source files to TypeScript and use the exceptions only as defined there.
