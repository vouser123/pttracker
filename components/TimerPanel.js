      ...
      <section className={styles.panel} aria-label="Exercise timer and counter">
        <header className={styles.header}>
          ...
          <button
            ...
            type="button"
            onPointerUp={onClose}
            aria-label="Close exercise logger"
          >
            ×
          </button>
        </header>
        ...
        {timer.mode === 'reps' && (
          <div className={styles.modeBlock}>
            ...
            <button
              ...
              onPointerUp={timer.incrementCounter}
            >
              {timer.counterValue}
            </button>
            <div className={styles.controlRow}>
              <button
                ...
                onPointerUp={timer.decrementCounter}
              >
                − Undo
              </button>
            </div>
        ...
        {isTimerMode && (
          <div className={styles.modeBlock}>
            ...
            <div className={styles.controlRow}>
              ...
              <button type="button" className={styles.secondaryBtn} onPointerUp={timer.resetTimer}>
                Reset
              </button>
            </div>
          </div>
          ...
          {timer.isSided ? (
            <>
              <div className={styles.setInfoRow}>
                <span>👈 Left:</span>
                <span>
                  {leftCount}/{targetSets}
                </span>
              </div>
              <div className={styles.setInfoRow}>
                <span>👉 Right:</span>
                <span>
                  {rightCount}/{targetSets}
                </span>
              </div>
            </>
          ) : (
        ...
        <footer className={styles.controlFooter}>
          <button type="button" className={styles.secondaryBtn} onPointerUp={onPrevious}>
            Previous
          </button>
          <button
            type="button"
        ...
        <button type="button" className={styles.finishBtn} onPointerUp={onFinish ?? onClose}>
          Done
        </button>
        <button
          type="button"
          className={styles.pocketBtn}
          onPointerUp={() => setIsPocketOpen(true)}
        >
          Pocket Mode
        </button>
        <button type="button" className={styles.backBtn} onPointerUp={onBack ?? onClose}>
          ← Back to Exercises
        </button>
      </section>
      <PocketModeOverlay
